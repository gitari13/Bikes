...
<span class="price">Ksh<?php echo htmlentities($result->PricePerDay);?> /hour</span> 
</div>
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-user" aria-hidden="true"></i>4+</h2>
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-bicycle" aria-hidden="true"></i>8+</h2>
            <p>Used Bicycle</p>
          </div>
        </div>
      </div>
