...
//include('stk-push.php');
  ...
  $subscription = $_POST['subscription'];
    ...
    $subscription = ''; // or some default value
}
  ...
  $_SESSION['amount'] = $amount;
   ...
   //Simulate payment initiation (replace with actual M-Pesa API call)
...
.button button {
  ...
  .button button i {
   ...
   <div class="container">
    <form action='stk-push.php' method='POST'>
    <div class="price">
    ...
    <div class="card__container">
        <div class="card">
            <div class="row">
                    <img src=".\assets\images\mpesa.png" style="width:30%;margin: 0 35%;">
            ...
            <div class="row number">
                <div class="info">
                    ...
                    <input type="hidden" name="subscription" value="" /> <!-- For testing purposes, we have added the value. This should proceed from your website -->
